    ...
    <main>
      ...
      <div class="header">
        ...
        <div class="housing_title">
          <h1>Auden Buffalo</h1>
          <a href="https://www.audenbuffalo.com/">Learn more</a>
        </div>
        ...
        <div class="slideshow-container fade">
          ...
          <div class="Containers">
            ...
            <img src="Auden1.jpg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">2 / 3</div>
            <img src="Auden2.jpeg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">3 / 3</div>
            <img src="Auden3.jpeg" style="width:100%">
          </div>
