    ...
    <main>
      ...
      <div class="header">
        ...
        <div class="housing_title">
          <h1>Bengal Hall</h1>
          <a href="https://residencelife.buffalostate.edu/bengal-hall">Learn more</a>
        </div>
        ...
        <div class="slideshow-container fade">
          ...
          <div class="Containers">
            ...
            <img src="Bengal1.jpeg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">2 / 3</div>
            <img src="Bengal2.jpeg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">3 / 3</div>
            <img src="Bengal3.jpeg" style="width:100%">
          </div>
