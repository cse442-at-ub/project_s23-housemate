    ...
    <main>
      ...
      <div class="header">
        ...
        <div class="housing_title">
          <h1>Bishop Hall</h1>
          <a href="https://residencelife.buffalostate.edu/bishop-hall">Learn more</a>
        </div>
        ...
        <div class="slideshow-container fade">
          ...
          <div class="Containers">
            ...
            <img src="bishop1.webp" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">2 / 3</div>
            <img src="bishop2.jpeg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">3 / 3</div>
            <img src="bishop3.jpeg" style="width:100%">
          </div>
