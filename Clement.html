    ...
    <main>
      ...
      <div class="header">
        ...
        <div class="housing_title">
          <h1>Clement Hall</h1>
          <a href="https://www.buffalo.edu/administrative-services/managing-facilities/planning-designing-and-construction/building-profiles/profile-host-page.host.html/content/shared/university/page-content/facilities/clemnt.detail.html">Learn more</a>
        </div>
        ...
        <div class="slideshow-container fade">
          ...
          <div class="Containers">
            ...
            <img src="clement1.jpg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">2 / 3</div>
            <img src="clement2.jpg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">3 / 3</div>
            <img src="clement3.jpg" style="width:100%">
          </div>
