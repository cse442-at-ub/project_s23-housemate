    ...
    <main>
      ...
      <div class="header">
        ...
        <div class="housing_title">
          <h1>Flint Village Apartments</h1>
          <a href="https://www.buffalo.edu/campusliving/find-your-home/where-can-i-live/apartments/flint-village-apartments.html">Learn more</a>
          <br>
        ...
        <div class="slideshow-container fade">
          ...
          <div class="Containers">
            ...
            <img src="Flint_Village_Apartments1.jpeg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">2 / 3</div>
            <img src="Flint_Village_Apartments2.jpeg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">3 / 3</div>
            <img src="Flint_Village_Apartments3.jpeg" style="width:100%">
          </div>
