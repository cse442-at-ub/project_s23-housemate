    ...
    <main>
      ...
      <div class="header">
        ...
        <div class="housing_title">
          <h1>Moore Hall</h1>
          <a href="https://residencelife.buffalostate.edu/moore-complex">Learn more</a>
        </div>
        ...
        <div class="slideshow-container fade">
          ...
          <div class="Containers">
            ...
            <img src="Moore1.webp" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">2 / 3</div>
            <img src="Moore2.webp" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">3 / 3</div>
            <img src="Moore3.jpeg" style="width:100%">
          </div>
