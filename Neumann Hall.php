    ...
    <main>
      ...
      <div class="header">
        ...
        <div class="housing_title">
          <h1>Neumann Hall</h1>
          <a href="https://residencelife.buffalostate.edu/neumann-hall">Learn more</a>
        </div>
        ...
        <div class="slideshow-container fade">
          ...
          <div class="Containers">
            ...
            <img src="Neumann1.jpeg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">2 / 3</div>
            <img src="Neumann2.webp" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">3 / 3</div>
            <img src="Neumann3.webp" style="width:100%">
          </div>
