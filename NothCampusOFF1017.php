...
<link href="bootstrap.min.css" rel="stylesheet">
            ...
            <li class="nav-item dropdown">
              ...
              <div>
                <input type="radio" id="huey" name="drone" value="huey"
                      checked>
                <label for="huey">$1000 - $1700</label>
              </div>
             </ul>
            </li>
            <li>
  ...
  <main>
    ...
    <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1FhpyNFfpCnawVRY_TamucTVWx-E4QSs&ehbc=2E312F" width = "100%" height = "1000px" style = "border: 0;" allowfullscreen = "" loading = "lazy"></iframe>
