...
<link href="bootstrap.min.css" rel="stylesheet">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <?php 
                  echo '<li><a class="dropdown-item" href="masterHouseSelect.php?housingName=University Village at Sweethome">University Village at Sweethome</a></li>';
                ?>
              </ul>
            </li>
            <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown">
              ...
              <div onClick="window.location = 'NothCampusOFF1017.php';">
                <input type="radio" id="louie" name="drone" value="louie">
                <label for="louie">$1000 - $1700</label>
              </div>
             </ul>
            </li>
          </ul>
  ...
  <main>
    ...
    <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1NlGtE-VzRM8_OLTai3aoZiTKLQ8HCGE&ehbc=2E312F" width = "100%" height = "1000px" style = "border: 0;" allowfullscreen = "" loading = "lazy"></iframe>
