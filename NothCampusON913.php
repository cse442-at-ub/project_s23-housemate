          ...
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <?php 
                  echo ' <li><a class="dropdown-item" href="masterHouseSelect.php?housingName=South Lake Village Apartments">South Lake Village Apartments</a></li>
                  <li><a class="dropdown-item" href="masterHouseSelect.php?housingName=Flickinger Court Apartments">Flickinger Court Apartments</a></li>
';
                ?>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <div onClick="window.location = 'NothCampusON89.php';">
                <input type="radio" id="last" name="drone" value="last">
                <label for="last">$800 - $900</label>
              </div>
              <div>
                <input type="radio" id="huey" name="drone" value="huey"
                      checked>
                <label for="huey">$900 - $1300</label>
              </div>
             </ul>
            </li>
            <li class="nav-item dropdown">
  ...
  <main>
    ...
    <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1ap2E2K7DV34nE9LAw0PtvYvtv8B47JY&ehbc=2E312F" width = "100%" height = "1000px" style = "border: 0;" allowfullscreen = "" loading = "lazy"></iframe>
