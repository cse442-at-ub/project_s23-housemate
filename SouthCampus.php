      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <!--
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">Distance</a>
              <ul class="dropdown-menu">
                <input type="checkbox">
                <label><a> 1 mile </a></label><br>
                <input type="checkbox">
                <label> <a> 5 mile </a></label><br>
                <input type="checkbox">
                <label> <a> 10 mile </a></label><br>
                <input type="checkbox">
                <label> <a> 20 mile </a></label><br>
              </ul>
            </li>
            -->
          </ul>
