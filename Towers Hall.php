    ...
    <main>
      ...
      <div class="header">
        ...
        <div class="housing_title">
          <h1>Towers</h1>
          <a href="https://residencelife.buffalostate.edu/towers">Learn more</a>
        </div>
        ...
        <div class="slideshow-container fade">
          ...
          <div class="Containers">
            ...
            <img src="Towers1.jpeg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">2 / 3</div>
            <img src="Towers2.jpeg" style="width:100%">
          </div>

          <div class="Containers">
            <div class="MessageInfo">3 / 3</div>
            <img src="Towers3.webp" style="width:100%">
          </div>
